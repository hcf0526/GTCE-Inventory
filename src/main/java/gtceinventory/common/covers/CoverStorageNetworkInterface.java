...
public class CoverStorageNetworkInterface extends CoverBehavior implements CoverWithUI, ITickable, IControllable {
    ...
    protected int moveInventoryItems(IStorageNetwork sourceInventory, IItemHandler targetInventory, int maxTransferAmount) {
        ...
        Set<ItemStackKey> storedItems = new HashSet<>(sourceInventory.getStoredItems()); // TODO CCME
        for (ItemStackKey key : storedItems) {
    ...
    public <T> T getCapability(Capability<T> capability, T defaultValue) {
        if (capability == GTCEInventoryCapabilities.CAPABILITY_STORAGE_NETWORK) {
            ...
            return GTCEInventoryCapabilities.CAPABILITY_STORAGE_NETWORK.cast(storageNetworkWrapper);
        }
